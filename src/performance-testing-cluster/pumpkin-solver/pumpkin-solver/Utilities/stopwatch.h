...
{
public:
	Stopwatch() :starting_time(time(0)), time_limit_in_seconds(0) {}
	Stopwatch(double time_limit_in_seconds) :starting_time(time(0)), time_limit_in_seconds(time_limit_in_seconds) {}
