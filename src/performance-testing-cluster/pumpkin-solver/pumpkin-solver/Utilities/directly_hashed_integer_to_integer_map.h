...
{
//todo description
class DirectlyHashedIntegerToIntegerMap
{
public:
	DirectlyHashedIntegerToIntegerMap(int num_values); //values in the set must be within [0,.., num_values)
